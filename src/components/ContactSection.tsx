...
export function ContactSection() {
  return <section id="contact" className="py-20 md:py-28 relative" aria-labelledby="contact-heading">
    <div className="max-w-5xl mx-auto px-5 sm:px-8 relative z-10 text-center">
      ...
      <p className="text-gray-400 text-lg sm:text-xl mt-6 max-w-3xl mx-auto leading-relaxed">Referee contact details and supporting documents are available privately to the JESA judging panel. I welcome questions about what I did, what the team did, and what I would improve.</p>
